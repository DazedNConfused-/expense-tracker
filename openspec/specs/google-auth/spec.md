...
Handles Google OAuth 2.0 authentication using Google Identity Services. Controls access to all app functionality and manages session state, token storage, and token expiry.
