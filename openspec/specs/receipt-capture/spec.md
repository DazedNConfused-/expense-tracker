...
Handles receipt capture (camera or file upload), client-side image compression, upload to Google Drive, and linking the receipt URL to the expense row in the sheet.
