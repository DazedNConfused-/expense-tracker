...
Manages all read and write operations between the app and the user's Google Sheet. Handles sheet creation, schema enforcement, and CRUD operations for expense rows.
